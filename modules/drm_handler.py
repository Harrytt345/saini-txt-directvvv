...
async def drm_handler(bot: Client, m: Message):
    ...
    for idx, i in enumerate(lines):
        if "://" in i:
            url = i.split("://", 1)[1]
            title = lines[idx - 1].strip() if idx > 0 and "://" not in lines[idx - 1] else ""
            links.append([title, i.split("://", 1)[1]])
            if ".pdf" in url:
                pdf_count += 1
    ...
    if m.document:
        ...
        try:
            start_index = int(raw_text) if '-' not in raw_text else int(raw_text.split('-')[0])
...
#........................................................................................................................................................................................
    failed_count = 0
    count = int(raw_text) if '-' not in raw_text else int(raw_text.split('-')[0])
    arg = int(raw_text) if '-' not in raw_text else int(raw_text.split('-')[0])
    try:
